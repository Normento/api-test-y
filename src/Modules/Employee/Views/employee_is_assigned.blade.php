                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            <strong> 1 </strong> employé vient de vous etre assigné par le service recrutement
                                                             {{-- <strong>{{$employee->count() }}</strong>

                                                            {{ $employee->count() > 1 ? 'employés' : 'employé' }}

                                                            {{ $employee->count() > 1 ? 'viennent' : 'vient' }} d'être
                                                            affecté
                                                            par le service recrutement sur la commande business
                                                            récurrente de
                                                             <strong>{{ $businessRecurringOrder->recurringService->name }}</strong>
                                                            du client:
                                                            <strong>{{ $businessRecurringOrder->package->user->full_name }}</strong>. --}}
                                                        </p>

                                                        <br>
                                                        Ci dessous le nom de  l'employé
                                                        ...
                                                        <p style="margin: 0 0 16px;">
                                                            Cordialement, <br>L'équipe Ylomi
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
