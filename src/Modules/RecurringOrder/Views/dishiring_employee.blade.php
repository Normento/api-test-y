                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            Le contrat de prestation de l'employé
                                                            {{ $proposition->employee->full_name }} dont
                                                            l'employeur est
                                                            {{ $proposition->recurringOrder->user->first_name }}
                                                            {{ $proposition->recurringOrder->user->last_name }}
                                                            prend fin à compter de
                                                            <strong>{{ \Carbon\Carbon::parse($proposition->end_date)->locale('fr_FR')->isoFormat('OD MMMM YYYY') }}</strong>
