                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            @if ($suivi_type == 'employee')
                                                                Vous recevez ce mail en lieu du rapport de suivi des
                                                                employés effectué par le département RH.
                                                            @else
                                                                Vous recevez ce mail en lieu du rapport de suivi des
                                                                clients effectué par le département commercial.
                                                            @endif·
                                                            <br>
                                                        ...
                                                        @if ($suivi_type == 'employee')
                                                            <p style="margin: 0 0 24px;">
                                                                {{ $unreachable }} suivis employés injoignable
                                                            </p> <br>
                                                            <p style="margin: 0 0 24px;">
                                                                {{ $ras }} suivis rien à signaler
                                                            </p> <br>
                                                            @if (count($suivis) != 0)
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <strong>Date de
                                                                                                        ...
                                                                                                        style="color: #382DB8;">
                                                                                                        {{ \Carbon\Carbon::parse($value->suivis_date)->locale('fr_FR')->isoFormat('OD MMMM YYYY') }}</span>
                                                                                                </td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="color: #382DB8;">{{ $value->suivisMakeBy->full_name }}
                                                                                                    </span>
                                                                                                </td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="color: #382DB8;">{{ $value->resum }}
                                                                                                    </span>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                        ...
                                                        @else
                                                            <p style="margin: 0 0 24px;">
                                                                {{ $unreachable }} suivis client injoignable
                                                            </p> <br>
                                                            <p style="margin: 0 0 24px;">
                                                                {{ $ras }} suivis rien à signaler
                                                            </p> <br>
