                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            <strong>{{ count($employeesAssigned) }}</strong>
                                                            <strong>{{ $businessRecurringOrder->recurringService->name }}</strong>
                                                            du client
                                                            {{ $businessRecurringOrder->user->first_name }}   {{ $businessRecurringOrder->user->last_name }}
                                                            {{ count($employeesAssigned) > 1 ? 'viennent' : 'vient' }}
                                                            de prendre fonction en tant qu'employé déclaré à la CNSS à
                                                            compter de
                                                            <strong>{{ \Carbon\Carbon::parse($businessRecurringOrder->propositions->started_date)->locale('fr_FR')->isoFormat('OD MMMM YYYY') }}</strong>.
                                                            <br>
                                                            Il s'agit de:

                                                            @foreach ($employeesAssigned as $employeeAssigned)
                                                                <ul>
                                                                    <li><strong>{{ $employeeAssigned->full_name }}</strong>
                                                                    </li>
                                                                </ul>
                                                            @endforeach
                                                        ...
                                                        <br> NB: <strong> Cette déclaration entrera en vigueur dans
                                                            trois mois, à condition que ces derniers restent actifs et
                                                            que le client ou le super admin maintienne l'application du
                                                            CNSS . </strong>
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p
                                            ...
                                            Copyright {{ $year }}
                                            <a href="https://www.ylomi.net/" class="hover-underline"
