...
<head>
  ...
  <![endif]-->
    <title>Comfirmation de deployement</title>
                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                           <strong> {{ $co->first_name }} {{ $co->last_name }} </strong> vient de
                                                            confirmer le déploiement d'un employé qui prend fonction à partir du
                                                         <strong>{{ \Carbon\Carbon::parse($contrat_started_date)->locale('fr_FR')->isoFormat('OD MMMM YYYY') }}</strong>
                                                            chez le client
                                                            <strong>{{ $businessRecurringOrder->user->first_name }}  {{ $businessRecurringOrder->user->last_name }}</strong>.
                                                        </p>
                                                        <br>
                                                        Il s'agit de :
                                                            <ul>
                                                                <li><strong>{{ $employeesAssigned->full_name }}</strong>
                                                                </li>
                                                            </ul>

                                                        <p style="margin: 0 0 16px;">Cordialement, <br>L'équipe Ylomi
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
