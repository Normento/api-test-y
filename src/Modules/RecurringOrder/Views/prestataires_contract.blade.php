...
<p>
    Ci-après dénommée <strong>"Client"</strong>;
</p>
...
<p>
    Ci-après dénommé <strong>"Prestataire"</strong>
</p>
...
<p>
    ...
    @else
    Le présent contrat qui prend effet à compter de la date du deploiement de l'employée, est conclu pour une durée
    <strong> d'un (01) an
        renouvelable par tacite reconduction</strong>. Une période d’essai d’un
    (01) mois est requise. Au cours de ladite période, l’employeur peut rompre le contrat sans
    indemnité pour faute grave ou insuffisance de travail.
...
<p>
    ...
    possibilités de congé de deux (02) jours par mois selon que Le prestataire soit hébergé(e) ou
...
<p>
    ...
    fautes lourdes etc..) verbal ou écrit à l’endroit de Le prestataire constitue un préavis et peut conduire à la
    rupture
    du contrat.</strong>
</p>
...
<p>
    Le lieu de la prestation est le domicile ou lieu de travail du client de Ylomi ou tout autre lieu retenu de commun
    accord. Le prestataire est invité à y être présent exclusivement pour l’exercice de ses activités professionnelles.
    Le prestataire n’est pas autorisé à quitter son poste et ou le lieu de prestation pendant toute la durée de ses
...
<ul>
    <li>
        <u>Secret professionnel:</u> Le prestataire est lié(e) par le secret professionnel relatif à toute information
    ...
    <li>
        <u>Règles déontologiques:</u> Le prestataire est tenu(e) de se conformer aux principes et règles
    ...
    <li>
        <u>Clause de non concurrence:</u> Le prestataire s’engage à consacrer tout son temps dans les limites des
...
<p>
    Le prestataire répond de tout dommage qu’il (elle) causera par négligence grave ou intentionnellement. Le
...
<p>
    En cas de désaccord, les deux parties s’engagent à rechercher d’abord des solutions à l’amiable. Le For est basé à
    Cotonou.
...
<p>
    Fait à Cotonou, le
    {{ is_null($proposition->started_date)? \Carbon\Carbon::now()->locale('fr_FR')->isoFormat('OD MMMM
    YYYY'): \Carbon\Carbon::parse($proposition->started_date)->locale('fr_FR')->isoFormat('OD MMMM
    YYYY') }}
...
<table style='width: 100vw;'>
    <tr>
        <th style='text-align: left; font-weight: 400'>Le prestataire:</th>
    ...
    <tr>
        <td>
            <p>
                ...
                <br>
                <img src="{{ $signature }}" height="70" width="90"
