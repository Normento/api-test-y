                                ...
                                <tr>
                                    <td class="sm-py-32 sm-px-24"
                                        ...
                                        <a href="https://www.ylomi.net/">
                                            <img src="{{ asset('images/logo.png') }}" width="155" alt="Vuexy Admin"
                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            Votre portefeuille YLOMI vient d'être crédité de
                                                            <strong>{{ $amount }}<sup>F</sup></strong> pour le compte du
                                                            paiement des frais de prestation  de votre
                                                            profil <strong>{{ $employee->full_name }}</strong>. <br> Le
                                                            nouveau solde de votre portefeuille est
                                                            <strong>{{ $currentAmount }}<sup>F</sup></strong>.
                                                        </p>
