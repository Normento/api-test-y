                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p>
                                                            L'employé
                                                            <strong>{{ $payment->employee->full_name }} </strong> vient
                                                            de recevoir sur le numéro
                                                            <strong>{{ $number }}</strong> un montant de
                                                           <strong> {{ $balance }} FCFA</strong> comme salaire du mois de
                                                            {{ $payment->month_salary }} {{ $payment->year }} après paiement des frais de prestation
                                                            du client {{ $user->first_name }} {{ $user->last_name }}
