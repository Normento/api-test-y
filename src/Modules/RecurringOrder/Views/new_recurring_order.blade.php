                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        @if (is_null($companyStaff))
                                                            <p style="margin: 0 0 24px;">
                                                                Nous sommes très honorés de vous compter parmi nos
                                                                client(es) PRIVILEGIÉ(ES) et nous vous en remercions
                                                                infiniment
                                                                pour la confiance.
                                                            </p>
                                                            <br>
                                                            <p style="margin: 0 0 24px;">
                                                                {{ count($orders) > 1 ? 'Vos commandes ' : 'Votre commande' }}
                                                                de
                                                                @foreach ($orders as $order)
                                                                    <strong>
                                                                        {{ $order->recurringService->name }}
                                                                    </strong>
                                                                @endforeach
                                                                {{ count($orders) > 1 ? 'ont été ' : 'a été ' }}
                                                                bien enregistrée{{ count($orders) > 1 ? '(s)' : '' }}  et un de nos
                                                                collaborateurs va vous contacter incessamment pour
                                                                requérir
                                                                plus de détails et vous expliquer les étapes suivantes.
                                                            </p>
                                                            <p style="margin: 0 0 24px;">
                                                                Il/elle sera votre gestionnaire de portefeuille
                                                                (Chargé(e)
                                                                d'Affaire) durant toute la durée de votre collaboration
                                                                avec
                                                                nous.
                                                            </p>
                                                            <br>
                                                            <p style="margin: 0 0 24px;">
                                                                N'hésitez surtout pas de contacter directement la
                                                                Direction
                                                                Générale de Ylomi au 67 28 48 48 pour tout comportement
                                                                non
                                                                professionnel de sa part.
                                                            </p>

                                                            <p style="margin: 0 0 24px;">
                                                                Ensemble, révolutionnons le secteur de service à
                                                                domicile au
                                                        ...
                                                        @else
                                                            <p style="margin: 0 0 24px;">
                                                                ...
                                                                @endforeach
                                                                {{ count($orders) > 1 ? 'ont été ' : 'a été ' }}
                                                                bien enregistrée(s) et nous vous en remercions pour
                                                                votre confiance renouveler
                                                            </p>
                                                            <br>

                                                            <p style="margin: 0 0 24px;">
                                                                Votre Chargé d’affaire Mr/Mme
                                                                <strong>{{ $companyStaff->first_name }}
                                                                    {{ $companyStaff->last_name }}</strong> qui
                                                                gère votre dossier fera diligence pour un traitement
                                                                rapide de votre commande
                                                            </p>
                                                            <br>
                                                            <p style="margin: 0 0 24px;">
                                                                N'hésitez surtout pas  de contacter directement la
                                        ...
                                        <p align="center" style="cursor: default; margin-bottom: 16px;">
                                            <a href="https://www.facebook.com/ylomi"
                                                style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                                    src="{{ asset('images/facebook.png') }}" width="17"
                                                    alt="Facebook"
                                            ...
                                            <a href="https://twitter.com/pixinvents"
                                                style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                                    src="{{ asset('images/twitter.png') }}" width="17"
                                                    alt="Twitter"
                                                    style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                            •
                                            <a href="https://www.instagram.com/pixinvents"
                                                style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                                    src="{{ asset('images/instagram.png') }}" width="17"
                                                    alt="Instagram"
                                                    style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                        </p>
                                        <p align="center"
                                            style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); cursor: default; margin-bottom: 16px;">
                                            Ylomi - {{ $year }}</p>
                                    </td>
                                </tr>
                            </tbody>
