                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            ...
                                                            employé
                                                            <strong>
                                                                {{ $proposition->employee->full_name }}</strong>
                                                            prend effet à partir de ce jour , suite à sa déclaration à
                                                            la CNSS il y a trois mois le
                                                            <strong>{{ \Carbon\Carbon::parse($proposition->started_date)->locale('fr_FR')->isoFormat('OD MMMM YYYY') }}</strong>
                                                            sur la commande business récurrente du
                                                            client
                                                            <strong>{{ $proposition->RecurringOrder->user->first_name }}   {{ $proposition->RecurringOrder->user->last_name }}</strong>
                                                            en tant que
                                                            <strong>{{ $proposition->RecurringOrder->recurringService->name }}</strong>
