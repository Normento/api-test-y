                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong> Bonjour Mr/Mme {{ $admin->first_name }}
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                                style="line-height: 39.2px; font-size: 28px;">Retrait d'un admin du dashboard YLOMI
                                                                               </span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        ...
                                                                        <p style="margin: 0 0 24px;">Le
                                                                            ...
                                                                            vient d'être retiré  du dashboard YLOMI
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 160%; font-size: 14px;"><span
                                                                        style="font-size: 18px; line-height: 28.8px;">Bonne
                                                                        suite à vous dans vos différentes
                                                                        missions.!!!.</span></p>
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://facebook.com/ylomi"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                    ...
                                                                    <table align="left" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://www.linkedin.com/company/ylomi"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                    ...
                                                                    <table align="left" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://www.instagram.com/ylomi_app/"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                    ...
                                                                    <table align="left" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://www.youtube.com/@ylomisas"
                                                                                        title="YouTube"
                                                                                        target="_blank">
