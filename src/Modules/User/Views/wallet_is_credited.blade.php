                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            Le client <strong>{{ $clientFullName }}</strong> vient de
                                                            créditer son portefeuille de
                                                            <strong>{{ $montantDuDepot }}<sup>F</sup></strong>, le
                                                            nouveau solde est
                                                            <strong>{{ $soldeActuel }}<sup>F</sup></strong>.
                                                        </p>
