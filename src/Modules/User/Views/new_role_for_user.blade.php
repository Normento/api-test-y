                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://assets.unlayer.com/projects/191538/1697624867001-image-5.png"
                                                                            alt="Image" title="Image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 29%;max-width: 162.4px;"
                                                                            width="162.4" />
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong> Bonjour Mr/Mme {{ $user->first_name }}
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                                style="line-height: 39.2px; font-size: 28px;">Attribution
                                                                                d'un nouveau rôle par le super
                                                                                admin</span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        ...
                                                                        <p style="margin: 0 0 24px;">Le rôle
                                                                            <strong style="color: #050411d2;">
                                                                                {{ $user->role->name }}
                                                                            </strong>
                                                                            vient de vous être attribué par le super
                                                                            admin
                                                                            <strong style="color: #050411d2;">
                                                                                {{ $admin->first_name }}
                                                                                {{ $admin->last_name }}.
...
<br>
En qualité de <strong style="color: #050411d2;">
    {{ $user->role->name }}
</strong> votre mission consistera à :  </strong> <span style="color: #382DB8;">
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 160%; font-size: 14px;"><span
                                                                        style="font-size: 18px; line-height: 28.8px;">Nous sommes convaincus que votre expérience et votre engagement seront des atouts précieux dans la réalisation de ces missions. Nous vous adressons nos meilleurs vœux pour la réussite de vos nouvelles missions.!!!.</span></p>
                                                                <p style="line-height: 160%; font-size: 14px;">&nbsp;
                                                                </p>
                                                                <p style="line-height: 160%; font-size: 14px;"><span
                                                                        style="font-size: 18px; line-height: 28.8px;">Coordialement,</span>
                                                                </p>
                                                                <p style="line-height: 160%; font-size: 14px;"><span
                                                                        style="font-size: 18px; line-height: 28.8px;">L'équipe
                                                                        Ylomi.</span></p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 160%;"><span
                                                                        style="line-height: 22.4px;"><span
                                                                            style="font-size: 20px; line-height: 32px;"><strong>Souriez</strong></span><strong
                                                                            style="font-size: 20px;">. On s'occupe de
                                                                            tout !</strong></span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 160%;">+229
                                                                    67283838</p>
                                                                <p style="font-size: 14px; line-height: 160%;"><a
                                                                        target="_blank" href="https://www.ylomi.net"
                                                                        rel="noopener"><span
                                                                            style="font-size: 16px; line-height: 25.6px; color: #000000;">www.ylomi.net</span></a>
                                                                </p>
                                                            </div>
