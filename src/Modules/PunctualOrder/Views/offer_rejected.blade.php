                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            Le client
                                                            {{ $offer->order->user->first_name }}
                                                            {{ $offer->order->user->last_name }}
                                                            a rejeté l'offre
                                                            {{ $offer->description }} pour
                                                            la commande de :
                                                            <strong>{{ $offer->order->recurringService->name }}</strong>.
                                                        </p>
                                                        <br>
                                                        <p style="margin: 0 0 24px;">
                                                        <h1>Raison du rejet: </h1>
                                                        <strong>{{ $proposition->rejection_reason }}</strong>
                                                        </p>
                                                        <p
