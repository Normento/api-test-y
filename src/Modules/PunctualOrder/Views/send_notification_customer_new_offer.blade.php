...
<head>
  ...
  <![endif]-->
    <title>Nouvelle offre pour votre commande</title>
...
<body
                                                ...
                                                <tr>
                                                    <td class="sm-px-24"
                                                        ...
                                                        <p style="margin: 0 0 24px;">
                                                            Vous avez <strong>{{$order->offers->count()}} </strong> {{$order->offers->count()== 1 ? " nouvelle offre" : " nouvelles offres"}}  pour votre commande de :
                                                            <strong>{{ $order->service->name }}</strong>.
                                                        </p>

                                                        <p>
                                                            <a href="https://ylomi.net/orders" style="
                               padding: 10px 15px;
 ...
 color: #ffffff;
                               ...
                               ">
                                                              {{$order->offers->count() == 1 ? " Voir l'offre" : " Voir les offres"}}
                                                            </a>
                                                        </p>
